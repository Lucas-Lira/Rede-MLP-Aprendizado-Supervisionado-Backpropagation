...
public class TelaPrincipalController implements Initializable {
    ...
    @FXML
    private ToggleGroup entrada1;
    @FXML
    private JFXTextField txtaxaaprendizado;
    @FXML
    private JFXTextField txerro;
    @FXML
    private JFXTextField txinteracoes;
    @FXML
    private RadioButton rbnormal;
    @FXML
    private RadioButton rbpassoPasso;
    @FXML
    private ToggleGroup entrada11;
    @FXML
    private JFXButton bAvancar;
    @FXML
    private JFXButton bAbrirArquivo;
    @FXML
